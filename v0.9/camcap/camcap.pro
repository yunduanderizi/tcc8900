...
install_include.files = Camapp.h rsc.h v4l2.h saclejpeg.h yuv2jpg.h
install_include.path  =$$INNOVBOX_CAMCAP_INSTALL_DIR/include

target.path  = $$INNOVBOX_CAMCAP_INSTALL_DIR/lib
