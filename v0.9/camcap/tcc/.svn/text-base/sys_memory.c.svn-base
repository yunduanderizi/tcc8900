...
{
	close(*pDev);
	munmap((void *)virtual_ptr, mem_size);
}
...
//	vpu_clock_init();
	...
	//restart VPU process..
	sys_free_virtual_addr( &membase, (unsigned long)(void*)regAddr_SWRESET, sizeof(tVPU_SWRESET));
	sys_free_virtual_addr( &membase, (unsigned long)(void*)regAddr_SOFTRESET, sizeof(tVPU_SOFTRESET));	
}
