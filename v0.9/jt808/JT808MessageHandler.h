...
private:
    ...
    void PacketHeadGZ( JT808Packet &packet, unsigned short id, ENUM_JT808_CRYTO crypto);
  void PacketHead(StruJT808Packet *packet, unsigned short id, ENUM_JT808_CRYTO crypto);
    ...
    void PacketCheckSumFlagGZ(JT808Packet *packet);
    ...
    JT808PacketFifo m_waitingQueue_0900;
