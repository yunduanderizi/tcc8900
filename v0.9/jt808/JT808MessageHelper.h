...
public:
   ...
   // static void HandleTermUpdate(JT808Packet &packet, int body, int len, unsigned short seq);
    ...
    static void Set0900PacketGZ(StruJT808Packet *thepacket1 , StruJT808Packet *thepacket2);
    ...
    static void SendLocationMultiGZ(struct LocStatusData *locData,  int num, int lock_door=WY_MAGIC);
    ...
    static void SendDriverInfo_GZ(int timeIndex);
    static void SendCarControl(unsigned short seq,int flag);
    static void SendMedia(ENUM_JT808_MEDIA_TYPE type, int index, int flag,int stop_time);
    ...
    static int IsDigit2(string str);
private:
