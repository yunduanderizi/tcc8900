...
//                                                                          Null  Case   Incre  Key           Value
    ...
    SQLiteColumn("StlD2",   ENUM_SQLite_COLUMN_INTEGER,      true, false, false, false, false, SQLiteValue(0)),
    SQLiteColumn("StlD3",   ENUM_SQLite_COLUMN_INTEGER,      true, false, false, false, false, SQLiteValue(0)),
    SQLiteColumn("StlD4",   ENUM_SQLite_COLUMN_INTEGER,      true, false, false, false, false, SQLiteValue(0)),
    SQLiteColumn("StlD5",   ENUM_SQLite_COLUMN_INTEGER,      true, false, false, false, false, SQLiteValue(0)),
    SQLiteColumn("StlD6",   ENUM_SQLite_COLUMN_INTEGER,      true, false, false, false, false, SQLiteValue(0)),
    SQLiteColumn("StlD7",   ENUM_SQLite_COLUMN_INTEGER,      true, false, false, false, false, SQLiteValue(0))
