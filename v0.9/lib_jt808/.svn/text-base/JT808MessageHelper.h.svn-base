...
public:
   ...
   // static void HandleTermUpdate(JT808Packet &packet, int body, int len, unsigned short seq);
    ...
    static void SendLocation(long long tableIndex);
    ...
    static void Send070008(int , int);
    static void Send070009(int , int);
    static void Send070010(int , int);
    static void Send070011(int , int);
    static void Send070012(int , int);
    static void Send070013(int , int);
    static void Send070014(int , int);
    static void Send070015(int , int);

    static int SendJT808LocReportNotify(int result);
    static int SendJT808TempLocReportNotify(int interval,int duration);
    static void SendJT808SettingUpdateNotifyC();
    static void SendJT808RebootNotify();
    static void SendJT808ShutDownNotify();
    static int SendJT808GnssUpdateNotify(int mode,int baud,int out,int fre);
    static void SendJT808FenceUpdateNotify(int flag,int type,int id,int state);
    static void SendJT808RectangleFenceUpdateNotify();
    static void SendJT808ParkingNotify(int flag);
private:
    static void PackLocation(VDRLocStatus1Table *table, JT808Packet &packet,int lock_door=WY_MAGIC);
